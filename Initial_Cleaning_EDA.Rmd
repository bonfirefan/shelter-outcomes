...
```{r}
g <- ggplot(data=cad, aes(x=breed_new, fill= OutcomeType_Adoption )) 
g + geom_bar(stat="count", position=position_dodge()) +
    ...
    facet_grid(~ OutcomeType_Adoption)
```

```{r}
g <- ggplot(data=cad, aes(x=Is_Dog, fill= OutcomeType_Adoption )) 
g + geom_bar(stat="count", position=position_dodge()) +
    xlab("Whether a cat is over average heart weight") +
    ggtitle("Gender distributin on over and below average heart weight group.") +
    facet_grid(~ OutcomeType_Adoption)
...
```{r}
g <- ggplot(data=cad, aes(x=Has_Name, fill= OutcomeType_Adoption )) 
g + geom_bar(stat="count", position=position_dodge()) +
    xlab("Whether a cat is over average heart weight") +
    ggtitle("Gender distributin on over and below average heart weight group.") +
    facet_grid(~ OutcomeType_Adoption)
...
```{r}
g <- ggplot(data=cad, aes(x=S_Organ_Status_Out_Intact, fill= OutcomeType_Adoption )) 
g + geom_bar(stat="count", position=position_dodge()) +
    xlab("Whether a cat is over average heart weight") +
    ggtitle("Gender distributin on over and below average heart weight group.") +
    facet_grid(~ OutcomeType_Adoption)
```
```{r}
g <- ggplot(data=cad, aes(x=AgeuponIntake, fill= OutcomeType_Adoption )) 
