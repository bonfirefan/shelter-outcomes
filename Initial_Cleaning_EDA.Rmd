...
Fixed Status: A shelter can leverage it's resources to perform procedures on their shelter animals and knowing what fixed statuses lead to better outcomes would help them better decide which animals might benefiit from surgical intervention.

Age Upon Outcome: In a similar vein, shelters can work to advertise certain animals that they realize are approaching certain ages that our models predict lead to worse outcomes. While ideally we would not need to know this info for training our model, we decided to include it since we felt this info was still actionable for the shelter to be able to use.
