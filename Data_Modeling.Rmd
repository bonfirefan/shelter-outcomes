...
```{r eval=FALSE}
qplot(svmConfusion, svmModel, data=xgb_test_out,  colour= actOutcome,
      geom = c("boxplot", "jitter"),
      main = "XGBoost: predicted vs. observed in test data",
      xlab = "Observed Outcome",
      ylab = "Predicted Outcome")
...
```{r eval=FALSE}
qplot(testing.set$OutcomeType, final_pred_rf,  colour= testing.set$OutcomeType,
      geom = c("boxplot", "jitter"),
      main = "XGBoost: predicted vs. observed in test data",
      xlab = "Observed Outcome",
      ylab = "Predicted Outcome")
...
```{r model-eval}
xgb_conf_class["Class: Adoption","Sensitivity"]
```
rfConfusion, 
xgb_conf,
multiNomOut_conf,
